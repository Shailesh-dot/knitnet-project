...
export default function Hero() {
  return (
    <section className="w-full min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
      ...
      {/* Description */}
      <p className="text-gray-500 text-lg max-w-[800px] mb-10">
      ...
      {/* CTA Button */}
      <button className="bg-black text-[#EEFF00] font-bold px-10 py-4 rounded-full text-lg hover:scale-105 transition-transform duration-300">
        Take Test
      </button>
